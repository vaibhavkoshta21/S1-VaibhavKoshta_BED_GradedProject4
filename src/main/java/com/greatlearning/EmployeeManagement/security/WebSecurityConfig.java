...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.antMatchers("/","/employees/save","/employees/showFormAdd","/employees/403", "/employees/ascending").hasAnyAuthority("USER","ADMIN")
		.antMatchers("/employees/showFormUpdate","/employees/delete").hasAuthority("ADMIN")
